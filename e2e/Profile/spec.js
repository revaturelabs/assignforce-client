...
describe("Assignforce development, Test Profile", function () {
    ...
    it("Checking Profile page", function () {
        ...
        profile.click();
        expect(browser.getCurrentUrl()).toBe("https://dev.assignforce.revaturelabs.com/profile/test.trainer@revature.com");

    });

    it("Check the profile section and make name changes", function () {
    ...
    it("Check the Skill section and make name changes", function () {
    ...
    it("Unavailability form", function () {
    ...
    it("Return to trainers and ensure changes have been saved", function (){
